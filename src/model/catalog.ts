...
export const ITEMS: Item[] = [
  // --- Bandages & wound care ---
  {
    ...
    category: 'bandages', unit: 'bandage', weightOz: 0.05, price: 4,
  ...
  },
  {
    ...
    category: 'bandages', unit: 'bandage', weightOz: 0.05, price: 5,
  ...
  },
  {
    ...
    category: 'bandages', unit: 'strip', weightOz: 0.017, price: 6,
  ...
  },
  {
    ...
    category: 'bandages', unit: 'pad', weightOz: 0.15, price: 4,
  ...
  },
  {
    ...
    category: 'bandages', unit: 'dressing', weightOz: 0.15, price: 5,
  ...
  },
  {
    ...
    category: 'bandages', unit: 'roll', weightOz: 0.7, price: 4,
  ...
  },
  {
    ...
    category: 'bandages', unit: 'syringe', weightOz: 0.5, price: 3,
  ...
  },
  {
    ...
    category: 'bandages', unit: 'wipe', weightOz: 0.05, price: 3,
  ...
  },
  {
    ...
    category: 'bandages', unit: 'packet', weightOz: 0.05, price: 5,
  ...
  },
  {
    ...
    category: 'bandages', unit: 'packet', weightOz: 0.1, price: 4,
  ...
  },
  {
    ...
    category: 'bandages', unit: 'roll', weightOz: 1.4, price: 6,
  ...
  },
  {
    ...
    category: 'bandages', unit: 'dressing', weightOz: 0.1, price: 9,
  ...
  },
  {
    ...
    category: 'bandages', unit: 'packet', weightOz: 0.05, price: 4,
  ...
  // --- Blister & foot care ---
  {
    ...
    category: 'blister', unit: 'strip', weightOz: 0.06, price: 9,
  ...
  },
  {
    ...
    category: 'blister', unit: 'dressing', weightOz: 0.15, price: 7,
  ...
  // --- Medications (all OTC, unit-dose — never bottles; Rx = flags only) ---
  {
    ...
    category: 'meds', unit: '2-pack', weightOz: 0.033, price: 5,
  ...
  },
  {
    ...
    category: 'meds', unit: '2-pack', weightOz: 0.038, price: 4,
  ...
  },
  {
    ...
    category: 'meds', unit: 'tablet', weightOz: 0.017, price: 4,
  ...
  },
  {
    ...
    category: 'meds', unit: 'tablet', weightOz: 0.025, price: 5,
    retailer: 'Imodium', purchaseUrl: buy('loperamide 2mg caplets'),
    imageUrl: null, imageAlt: null,
  },
  {
    id: 'aspirin', name: 'Aspirin 325 mg',
    application: 'Suspected heart attack — chew immediately.',
    category: 'meds', unit: 'tablet', weightOz: 0.025, price: 3,
  ...
  },
  {
    ...
    category: 'meds', unit: 'packet', weightOz: 0.2, price: 8,
  ...
  },
  {
    ...
    application: 'Sunburn.',
    category: 'meds', unit: 'packet', weightOz: 0.1, price: 4,
  ...
  },
  {
    ...
    category: 'meds', unit: 'tablet', weightOz: 0.017, price: 5,
  ...
  // --- Tools & instruments (qty 1 — tools never scale with group) ---
  {
    ...
    category: 'tools', unit: 'tool', weightOz: 0.2, price: 7,
  ...
  },
  {
    ...
    category: 'tools', unit: 'tool', weightOz: 0.1, price: 8,
  ...
  },
  {
    ...
    category: 'tools', unit: 'wipe', weightOz: 0.025, price: 4,
  ...
  },
  {
    ...
    category: 'tools', unit: 'tool', weightOz: 1.0, price: 6,
  ...
  },
  {
    ...
    category: 'tools', unit: 'pair', weightOz: 0.2, price: 3,
  ...
  },
  {
    ...
    category: 'tools', unit: 'pin', weightOz: 0.033, price: 2,
  ...
  },
  {
    ...
    category: 'tools', unit: 'inch', weightOz: 0.0115, price: 3,
  ...
  },
  {
    ...
    category: 'tools', unit: 'set', weightOz: 0.2, price: 2,
  ...
  },
  {
    ...
    category: 'tools', unit: 'roll', weightOz: 1.0, price: 5,
  ...
  },
  {
    ...
    category: 'tools', unit: 'mask', weightOz: 0.6, price: 8,
  ...
  },
  {
    ...
    category: 'tools', unit: 'blanket', weightOz: 1.8, price: 4,
  ...
  },
  {
    ...
    category: 'tools', unit: 'mask', weightOz: 0.4, price: 6,
  ...
  },
  {
    ...
    category: 'tools', unit: 'packet', weightOz: 0.3, price: 8,
  ...
  // --- Trauma layer (always offered per Kellock 2026-07-03; copy gated by training) ---
  {
    ...
    category: 'trauma', unit: 'tourniquet', weightOz: 2.4, price: 12,
  ...
  },
  {
    ...
    category: 'trauma', unit: 'bandage', weightOz: 0.9, price: 3,
  ...
  },
  {
    ...
    category: 'trauma', unit: 'pack', weightOz: 0.8, price: 20,
  ...
  },
  {
    ...
    category: 'trauma', unit: 'bandage', weightOz: 2.6, price: 9,
...
export const CONTAINERS: Container[] = [
  { id: 'own-bag', name: 'Use my own bag', desc: 'Contents only', weightOz: null, price: null, imageUrl: null },
  { id: 'ziplock', name: 'Ziplock bag', desc: 'Free; the ultralight standard', weightOz: null, price: null, imageUrl: null },
  { id: 'ul-zip-sack', name: 'Ultralight zip sack', desc: 'Transparent zip closure; no internal structure', weightOz: 1.1, price: 14, imageUrl: null },
  { id: 'organizer-pouch', name: 'Organizer pouch', desc: 'Internal compartments by category; opens flat', weightOz: 4.6, price: 28, imageUrl: null },
  { id: 'dry-pouch', name: 'Waterproof dry pouch', desc: 'Roll-top seal; submersion-rated', weightOz: 3.2, price: 24, imageUrl: null },
  { id: 'ammo-can', name: 'Ammo can', desc: 'Rigid, waterproof, crush-proof; rides strapped in', weightOz: 52, price: 25, imageUrl: null },
  { id: 'frame-bag', name: 'Top-tube pouch', desc: 'Rides on the bike; zip access without stopping', weightOz: 2.5, price: 22, imageUrl: null },
  { id: 'trunk-case', name: 'Rigid trunk case', desc: 'Latched hard case; visible and always in the car', weightOz: 28, price: 32, imageUrl: null },
]
