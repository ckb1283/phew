...
export const ACTIVITY_FAMILIES = ['foot', 'water', 'wheel', 'vehicle'] as const
export type ActivityFamily = (typeof ACTIVITY_FAMILIES)[number]

export const ACTIVITY_FAMILY: Record<Activity, ActivityFamily> = {
  backpacking: 'foot',
  kayaking: 'water',
  rafting: 'water',
  'cycle-touring': 'wheel',
...
export type Trigger =
  ...
  | { kind: 'activity'; activity: Activity } // one specific activity
  | { kind: 'activityFamily'; family: ActivityFamily } // a shared module (water, foot, wheel, vehicle)
